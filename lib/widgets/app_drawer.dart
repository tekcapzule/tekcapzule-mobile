  ...
  Widget build(BuildContext context) {
    ...
    List<SuggestedTopics> _suggestedTopics = [
      SuggestedTopics('assets/topics/ic_trending.png',
          'Cyber Security'),
      SuggestedTopics(
          'assets/topics/ic_sports.png', 'Edge Computing'),
      SuggestedTopics('assets/topics/ic_politics.png',
          'Human Augmentation'),
      SuggestedTopics('assets/topics/ic_business.png',
          'Intelligent process Automation'),
      SuggestedTopics(
          'assets/topics/ic_tech.png', 'Internet of Behaviours'),
      SuggestedTopics(
          'assets/topics/ic_travel.png', 'Mixed Reality'),
      SuggestedTopics(
          'assets/topics/ic_fashion.png', 'Tactile VR'),
      SuggestedTopics('assets/topics/ic_education.png',
          '5G'),
      SuggestedTopics(
          'assets/topics/ic_health.png', 'AI/ML'),
      SuggestedTopics(
          'assets/topics/ic_fun.png', 'Big Data'),
                        ...
                        child: ListView.builder(               
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, PageRoutes.news,
                                    arguments: _suggestedTopics[index].title);
                              },
                              child: Container(
