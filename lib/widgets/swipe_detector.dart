...
class SwipeConfiguration {
  ...
  double verticalSwipeMinDisplacement = 8.0;
  double verticalSwipeMinVelocity = 20.0;
  //Horizontal swipe configuration options
  double horizontalSwipeMaxHeightThreshold = 50.0;
  double horizontalSwipeMinDisplacement = 20.0;
  double horizontalSwipeMinVelocity = 20.0;
  SwipeConfiguration({
